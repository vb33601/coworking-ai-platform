...
import httpx
import os
from orch_app.models.schemas import SearchRequest, SearchResponse, RequirementExtractionResult, ConversationCreate, MessageRequest
from orch_app.agents.orchestrator_graph import AgentOrchestrator
from orch_app.memory.vector_store import MemoryManager, VectorStore
...
async def _fallback_recommendations(raw_input: str) -> Dict[str, Any]:
    ...
    from orch_app.core.config import get_settings
